	...
	<div class="row tags">
		<div class="col-md-12">	
			...
			<ul class="nav nav-tabs">
			  <li role="presentation" class="active"><a href="#">Transport</a></li>
			  <li role="presentation"><a href="#">Food</a></li>
			  <li role="presentation"><a href="#">Cell Phone</a></li>
			  <li role="presentation"><a href="#">Entertainment</a></li>
			</ul>
			<!--<div class="btn-group" role="group" aria-label="...">
				<button type="button" class="btn btn-default">Transport</button>
